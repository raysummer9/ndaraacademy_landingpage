  ...
  return (
    <section ref={sectionRef} className="py-12 sm:py-16 lg:py-20 bg-transparent">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        {/* Why NDARA Label */}
        <div className={`inline-flex items-center gap-2 sm:gap-3 bg-black text-lime-400 px-4 sm:px-6 py-2 sm:py-3 rounded-full mb-8 sm:mb-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 bg-lime-400 rounded-full"></div>
