...
const HeroSection = () => {
  return (
    <section className="px-4 sm:px-6 md:px-8 lg:px-6 pt-24 sm:pt-32 md:pt-40 lg:pt-48 pb-6 sm:pb-8 md:pb-12 lg:pb-16 bg-[#fffff0]">
      <div className="max-w-7xl mx-auto w-full">
        {/* Hero Content */}
        <div className="mb-8 sm:mb-12 md:mb-16">
          {/* Main Heading */}
          <h1 
            className="text-gray-900 mb-4 sm:mb-6 md:mb-8 max-w-full sm:max-w-4xl md:max-w-5xl lg:max-w-4xl text-left animate-fade-in-up text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-[60px] leading-tight sm:leading-tight md:leading-tight lg:leading-[74px] font-['Raleway'] font-semibold"
            style={{ 
              letterSpacing: '0%'
            }}
          >
          ...
          <p className="text-gray-600 mb-6 sm:mb-8 md:mb-12 max-w-full sm:max-w-3xl md:max-w-4xl lg:max-w-3xl animate-fade-in-up animation-delay-200 text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-[30px] leading-relaxed sm:leading-relaxed md:leading-relaxed lg:leading-[40px] font-['Raleway'] font-medium" style={{
            letterSpacing: '0%'
          }}>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-4 items-start animate-fade-in-up animation-delay-400">
            <Link 
              href="/coming-soon"
              className="inline-flex items-center justify-center w-full sm:w-auto px-6 sm:px-8 md:px-8 py-3 sm:py-4 md:py-4 bg-[#D7FF94] text-gray-900 font-semibold rounded-lg hover:bg-[#c4f085] transition-all duration-300 group hover:shadow-lg text-sm sm:text-base md:text-base"
            >
              Join a Workshop
              <svg 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 sm:gap-8 items-stretch">
          ...
          <div className="order-2 md:order-2 lg:order-2 md:col-span-1 lg:col-span-5 animate-fade-in-up animation-delay-400">
            <div className="bg-[#D7FF94] rounded-2xl p-6 sm:p-8 md:p-8 lg:p-10 relative w-full flex flex-col justify-between transition-all duration-300 hover:shadow-xl h-[397px] sm:h-[500px] md:h-[600px] lg:h-[742px]">
              {/* Mission Text */}
              <p className="text-gray-900 animate-fade-in-up animation-delay-600 text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-[43px] leading-tight sm:leading-tight md:leading-tight lg:leading-[52px] font-['Raleway'] font-medium" style={{
                letterSpacing: '0%'
              }}>
