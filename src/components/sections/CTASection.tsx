    ...
    <section ref={sectionRef} className="py-12 sm:py-16 lg:py-20 bg-transparent">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-16 sm:mb-20">
          ...
          {/* Action Buttons */}
          <div className={`flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <a 
              href="/community"
              target="_blank"
